          ...
          {section==='notificacoes' && (<>
            <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'1.5rem' }}>
              ...
              <div className="card">
                ...
                <div style={{ marginBottom:'1.2rem' }}><label className="field-lbl">Link (opcional)</label><input className="field-in" value={notifForm.url} onChange={e=>setNotifForm(p=>({...p,url:e.target.value}))} placeholder="Ex: /detalhe/7"/></div>
